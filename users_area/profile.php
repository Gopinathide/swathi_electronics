   ...
   <body class="main-layout">
    ...
    <div class="row">
       ...
       <div class="col-md-2">
           ...
           <ul class="navbar-nav bg-secondary text_center" style="height: 100vh;">
               <li class="nav-item bg-info">
                   <a class="nav-link text -light" href="#"><h4 style="color:white;text-align:center; margin:auto; margin-top:5px;">Profile</h4></a>
               </li>
               ...
               if(isset($_SESSION['username']))
               {
                   ...
                   <img src='./user_images/ $image' class='profile my-4' alt=''> 
               </li>";
               }
               ?>
               ...
               <br>
               <li class="nav-item ">
                   <a class="nav-link text -light" href="profile.php?user_order"><h4 style="color:white;text-align:center; margin:auto; margin-top:auto;">My Order</h4></a>
               </li>

               <li class="nav-item ">
                   <a class="nav-link text -light" href="profile.php?user_corder"><h4 style="color:white;text-align:center; margin:auto; margin-top:auto;">Completed Order</h4></a>
               </li>

               <li class="nav-item ">
                   <a class="nav-link text-light" href="profile.php?edit_account"><h4 style="color:white;text-align:center; margin:auto; margin-top:auto;">Edit Account</h4></a>
               </li>

               <li class="nav-item ">
                   <a class="nav-link text -light" href="profile.php?delete_account"><h4 style="color:white;text-align:center; margin:auto; margin-top:auto;">Delete Account</h4></a>
               </li>

               <li class="nav-item ">
                   <a class="nav-link text -light" href="../logout.php"><h4 style="color:white;text-align:center; margin:auto; margin-top:auto;">Logout </h4></a>
               </li>
           </ul>
       ...
       <div class="col-md-10">
          ...
          if(isset($_GET['user_corder']))
          {
             include('user_completedorder.php');
          }
          ?>
